            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('admin/replacement_class/cetak_pdf') }}" title="Print"><button class="btn btn-success btn-sm"><i aria-hidden="true"></i> Print</button></a>
                        <br/>
                        <br/>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nama Lengkap </th><td> {{ $replacementclass->nama_lengkap }} </td></tr><tr><th> Mata Kuliah </th><td> {{ $replacementclass->mata_kuliah }} </td></tr><tr><th> Kelas </th><td> {{ $replacementclass->kelas }} </td></tr><tr><th> Jadwal Kuliah </th><td> {{ $replacementclass->jadwal_kuliah }} </td></tr><tr><th> Jam Kuliah </th><td> {{ $replacementclass->jam_kuliah }} </td></tr><tr><th> Tanggal Replacement </th><td> {{ $replacementclass->tanggal_replacement }} </td></tr><tr><th> Jam Replacement </th><td> {{ $replacementclass->jam_replacement }} </td></tr><tr><th> Alasan </th><td> {{ $replacementclass->alasan }} </td></tr>
                                </tbody>
                            </table>
                        </div>
