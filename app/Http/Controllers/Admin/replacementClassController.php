...
class replacementClassController extends Controller
{
    ...
    {
        $replacementClass = replacementClass::all();

        // return view('admin.replacement-class.cetak_pdf')->with('flash_message', 'replacement-class View!');
        $pdf = PDF::loadview('admin/replacement-class/cetak_pdf',['replacementClass'=>$replacementClass]);
        return $pdf->download('admin.replacement-class.pdf');
    }
}
